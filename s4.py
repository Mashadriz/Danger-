...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @naamhaidev03"
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                response = f"𝘼𝙏𝙏𝘼𝘾𝙆 ♦️ 2♦️𝙀𝙉𝘿\n\n𝐓𝐀𝐑𝐆𝐄𝐓 --> {target}\n𝐏𝐎𝐑𝐓 --> {port}\n𝐓𝐈𝐌𝐄 --> {time} 𝐒𝐄𝐂.\n\n🌹🚀 𝘿𝘿𝙊𝙎 𝘾𝙃𝘼𝙏 𝙂𝙍𝙊𝙐𝙋 💬🌹"
                bot.reply_to(message, response)  # Notify the user that the attack is finished
        else:
            response = "⚠️1 𝙍𝙀𝘼𝘿𝙔 𝙏𝙊 𝙐𝙎𝙀⚠️\n\n/ʙɢᴍɪ2 <ᴛᴀʀɢᴇᴛ> <ᴘᴏʀᴛ> <ᴛɪᴍᴇ>\nₑₓ. ₋ ₂₅₇.₆₄.₅₅.₇ ₁₂₃₄₅ ₂₄₀\n𝙁𝙀𝙀𝘿𝘽𝘼𝘾𝙆 𝘿𝙀𝙉𝘼 👍\n\n★[🚀 𝘿𝘿𝙊𝙎 𝘾𝙃𝘼𝙏 𝙂𝙍𝙊𝙐𝙋 💬]★"  # Updated command syntax
    else:
        response = ("ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @naamhaidev03")
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @naamhaidev03"
...
𝘽𝙪𝙮 :- @naamhaidev03
𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 :- https://t.me/+0J5qNXH6_2AwNDg1
'''
...
def welcome_start(message):
    ...
    response = f'''🚀𝓦𝓔𝓛𝓒𝓞𝓜𝓔 𝓣𝓞 𝓟𝓡𝓔𝓜𝓘𝓤𝓜 𝓓𝓓𝓞𝓢 𝓑𝓞𝓣🤖, {user_name}! 𝓣𝓗𝓘𝓢 𝓘𝓢 𝓗𝓘𝓖𝓗 𝓠𝓤𝓐𝓛𝓘𝓣𝓨 𝓢𝓔𝓡𝓥𝓔𝓡 𝓑𝓐𝓢𝓔𝓓 𝓓𝓓𝓞𝓢. 𝓣𝓞 𝓖𝓔𝓣 𝓐𝓒𝓒𝓔𝓢𝓢.
🤖𝓣𝓡𝓨 𝓣𝓞 𝓡𝓤𝓝 𝓣𝓗𝓘𝓢 𝓒𝓞𝓜𝓜𝓐𝓝𝓓 : /help 
✅BUY :- @naamhaidev03'''
    bot.reply_to(message, response)
